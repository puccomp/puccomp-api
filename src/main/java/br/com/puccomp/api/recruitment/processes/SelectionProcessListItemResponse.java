 ...
 */
public record SelectionProcessListItemResponse(
        UUID id,
        String title,
    ...
    static SelectionProcessListItemResponse from(SelectionProcess process,
                                                 ApplicationCounts.ApplicationStats stats, Instant at) {
        return new SelectionProcessListItemResponse(
                process.getId(),
                process.getTitle(),
